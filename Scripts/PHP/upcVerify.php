...
require_once('/home/dbabler/dbabler.yaacotu.com/FED_2020/Scripts/PHP/function.php');

if(isset($_POST["upcEntry"])){
    $output = array();
    $output["upc_exists"] = does_upc_exist($_POST["upcEntry"]);
    $output["valid_upc"] = is_upc_valid($_POST["upcEntry"]);
    ...
    if ($output["upc_exists"]!=1 && $output["valid_upc"]!= 0){
        ...
        $web_address = $endpoint."?upc={$_POST["upcEntry"]}";
